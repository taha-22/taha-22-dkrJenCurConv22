 ...
 */
@Path("longExRate")
public class LongRateRS {

    @Context
    private UriInfo context;

    /**
     * Creates a new instance of LongRateRS
     */
    public LongRateRS() {
    }

    /**
     * Retrieves representation of an instance of myRS.LongRateRS
     * @return an instance of java.lang.String
     */
    @GET
    @Produces("text/plain")
    public String getText(@QueryParam("from")String from, 
                           @QueryParam("to")String to) {
        
        double cRate;
        
        //simulate intensive computation by intensively calcualting Pi
        PiLong logCompute = new PiLong();
        logCompute.delayByPi(50000);
        
        cRate = GetConversionRate(from, to);
        
        return (new Double(cRate).toString());
    ...
    private double GetConversionRate(String cur1, String cur2) {
        try {

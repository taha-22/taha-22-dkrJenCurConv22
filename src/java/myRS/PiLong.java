...
public class PiLong implements java.io.Serializable {
    ...
    public BigDecimal delayByPi(int precision) {
               
       long startTime = System.nanoTime();    
       
       BigDecimal result = computePi(precision);
       
       long endtime = System.nanoTime();    
       double estimatedTime = (System.nanoTime() - startTime) / 1E6;

       //System.out.println("In: " + estimatedTime + " miliSec, \n Pi is " + result);
       return result;
    }
